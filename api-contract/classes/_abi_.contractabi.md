...
*Defined in [Abi.ts:17](https://github.com/polkadot-js/api/blob/adee447cd/packages/api-contract/src/Abi.ts#L17)*
...
*Defined in [Abi.ts:13](https://github.com/polkadot-js/api/blob/adee447cd/packages/api-contract/src/Abi.ts#L13)*
...
*Defined in [Abi.ts:15](https://github.com/polkadot-js/api/blob/adee447cd/packages/api-contract/src/Abi.ts#L15)*
