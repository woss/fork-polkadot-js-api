...
*Defined in [promise/PromiseBlueprint.ts:14](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-contract/src/promise/PromiseBlueprint.ts#L14)*
...
*Defined in [base/Blueprint.ts:38](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-contract/src/base/Blueprint.ts#L38)*
...
*Defined in [base/Blueprint.ts:46](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-contract/src/base/Blueprint.ts#L46)*
