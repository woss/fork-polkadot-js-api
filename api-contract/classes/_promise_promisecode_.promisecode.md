...
*Defined in [promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-contract/src/promise/PromiseCode.ts#L13)*
...
*Defined in [base/Code.ts:39](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-contract/src/base/Code.ts#L39)*
...
*Defined in [base/Code.ts:47](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-contract/src/base/Code.ts#L47)*
