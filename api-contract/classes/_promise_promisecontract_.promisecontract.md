...
*Defined in [promise/PromiseContract.ts:14](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-contract/src/promise/PromiseContract.ts#L14)*
...
*Defined in [base/Contract.ts:34](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-contract/src/base/Contract.ts#L34)*
...
*Defined in [base/util.ts:69](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-contract/src/base/util.ts#L69)*
...
*Defined in [base/Contract.ts:36](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-contract/src/base/Contract.ts#L36)*
...
*Defined in [base/Contract.ts:37](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-contract/src/base/Contract.ts#L37)*
