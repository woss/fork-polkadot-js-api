...
*Defined in [packages/api-derive/src/accounts/idAndIndex.ts:16](https://github.com/polkadot-js/api/blob/adee447cd/packages/api-derive/src/accounts/idAndIndex.ts#L16)*
...
*Defined in [packages/api-derive/src/accounts/idAndIndex.ts:56](https://github.com/polkadot-js/api/blob/adee447cd/packages/api-derive/src/accounts/idAndIndex.ts#L56)*
