...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/370dc8681/packages/api-derive/src/accounts/idToIndex.ts#L28)*
