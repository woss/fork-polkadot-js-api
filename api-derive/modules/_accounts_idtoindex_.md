...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api-derive/src/accounts/idToIndex.ts#L28)*
