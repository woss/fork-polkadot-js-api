...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/accounts/idToIndex.ts#L28)*
