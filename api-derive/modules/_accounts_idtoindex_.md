...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/accounts/idToIndex.ts#L28)*
