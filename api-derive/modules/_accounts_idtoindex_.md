...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/859800280/packages/api-derive/src/accounts/idToIndex.ts#L28)*
