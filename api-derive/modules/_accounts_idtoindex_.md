...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/accounts/idToIndex.ts#L28)*
