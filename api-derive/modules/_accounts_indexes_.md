...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/553b3df0b/packages/api-derive/src/accounts/indexes.ts#L63)*
