...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/accounts/indexes.ts#L63)*
