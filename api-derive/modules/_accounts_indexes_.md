...
*Defined in [packages/api-derive/src/accounts/indexes.ts:72](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/accounts/indexes.ts#L72)*
