...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/accounts/indexes.ts#L63)*
