...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/accounts/indexes.ts#L63)*
