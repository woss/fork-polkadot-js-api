...
*Defined in [packages/api-derive/src/accounts/indexes.ts:72](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/accounts/indexes.ts#L72)*
