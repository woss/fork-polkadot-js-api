...
*Defined in [packages/api-derive/src/accounts/indexes.ts:72](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/accounts/indexes.ts#L72)*
