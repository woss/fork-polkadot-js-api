...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/accounts/indexes.ts#L63)*
