...
*Defined in [packages/api-derive/src/accounts/indexes.ts:63](https://github.com/polkadot-js/api/blob/196a0891b/packages/api-derive/src/accounts/indexes.ts#L63)*
