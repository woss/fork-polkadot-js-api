...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/accounts/indexToId.ts#L51)*
