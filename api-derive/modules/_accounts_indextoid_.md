...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-derive/src/accounts/indexToId.ts#L51)*
