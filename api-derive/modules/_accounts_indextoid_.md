...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/accounts/indexToId.ts#L51)*
