...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/196a0891b/packages/api-derive/src/accounts/indexToId.ts#L51)*
