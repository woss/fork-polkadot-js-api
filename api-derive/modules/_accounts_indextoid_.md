...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/accounts/indexToId.ts#L51)*
