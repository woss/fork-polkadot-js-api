...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/accounts/indexToId.ts#L51)*
