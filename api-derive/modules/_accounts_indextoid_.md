...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/accounts/indexToId.ts#L51)*
