...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:51](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/accounts/indexToId.ts#L51)*
