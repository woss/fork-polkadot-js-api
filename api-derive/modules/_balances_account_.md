...
*Defined in [packages/api-derive/src/balances/account.ts:82](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/balances/account.ts#L82)*
