...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/859800280/packages/api-derive/src/balances/account.ts#L83)*
