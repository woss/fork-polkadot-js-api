...
*Defined in [packages/api-derive/src/balances/votingBalances.ts:14](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/balances/votingBalances.ts#L14)*
