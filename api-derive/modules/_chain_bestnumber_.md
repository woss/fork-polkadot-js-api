...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/chain/bestNumber.ts#L25)*
