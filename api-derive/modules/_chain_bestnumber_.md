...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/69020faaa/packages/api-derive/src/chain/bestNumber.ts#L25)*
