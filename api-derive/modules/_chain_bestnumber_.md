...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/chain/bestNumber.ts#L25)*
