...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/0d067c9484/packages/api-derive/src/chain/bestNumber.ts#L25)*
