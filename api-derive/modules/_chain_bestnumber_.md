...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/044efbc6de/packages/api-derive/src/chain/bestNumber.ts#L25)*
