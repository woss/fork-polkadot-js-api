...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/chain/bestNumber.ts#L25)*
