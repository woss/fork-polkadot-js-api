...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/chain/getHeader.ts#L27)*
