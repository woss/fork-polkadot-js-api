...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/chain/getHeader.ts#L30)*
