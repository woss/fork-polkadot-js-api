...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/chain/getHeader.ts#L27)*
