...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/63573ca0de/packages/api-derive/src/chain/getHeader.ts#L27)*
