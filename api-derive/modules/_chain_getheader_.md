...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/f73609103/packages/api-derive/src/chain/getHeader.ts#L30)*
