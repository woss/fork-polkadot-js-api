...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/553b3df0b/packages/api-derive/src/chain/getHeader.ts#L30)*
