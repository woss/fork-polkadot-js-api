...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/790deca695/packages/api-derive/src/chain/getHeader.ts#L30)*
