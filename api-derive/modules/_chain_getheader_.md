...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/8bf5e51725/packages/api-derive/src/chain/getHeader.ts#L27)*
