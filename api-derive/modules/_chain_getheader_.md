...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-derive/src/chain/getHeader.ts#L27)*
