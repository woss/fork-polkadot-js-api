...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/f942510309/packages/api-derive/src/chain/getHeader.ts#L27)*
