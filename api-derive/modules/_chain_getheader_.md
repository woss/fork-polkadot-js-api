...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/602bb1406b/packages/api-derive/src/chain/getHeader.ts#L27)*
