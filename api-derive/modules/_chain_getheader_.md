...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api-derive/src/chain/getHeader.ts#L27)*
