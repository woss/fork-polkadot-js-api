...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/chain/getHeader.ts#L27)*
