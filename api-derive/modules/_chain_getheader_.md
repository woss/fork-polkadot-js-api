...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/85ae6f949/packages/api-derive/src/chain/getHeader.ts#L30)*
