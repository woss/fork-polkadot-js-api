...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/9184268c3d/packages/api-derive/src/chain/getHeader.ts#L27)*
