...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/859800280/packages/api-derive/src/chain/getHeader.ts#L30)*
