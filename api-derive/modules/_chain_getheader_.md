...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/chain/getHeader.ts#L27)*
