...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/chain/getHeader.ts#L27)*
