...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/chain/getHeader.ts#L27)*
