...
*Defined in [packages/api-derive/src/chain/getHeader.ts:30](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/chain/getHeader.ts#L30)*
