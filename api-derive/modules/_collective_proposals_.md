...
*Defined in [packages/api-derive/src/collective/proposals.ts:15](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/collective/proposals.ts#L15)*
