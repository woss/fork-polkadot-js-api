...
*Defined in [packages/api-derive/src/collective/proposals.ts:15](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/collective/proposals.ts#L15)*
