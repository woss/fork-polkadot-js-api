...
*Defined in [packages/api-derive/src/collective/proposals.ts:29](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/collective/proposals.ts#L29)*
