...
*Defined in [packages/api-derive/src/collective/proposals.ts:29](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/collective/proposals.ts#L29)*
