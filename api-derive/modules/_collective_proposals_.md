...
*Defined in [packages/api-derive/src/collective/proposals.ts:15](https://github.com/polkadot-js/api/blob/196a0891b/packages/api-derive/src/collective/proposals.ts#L15)*
