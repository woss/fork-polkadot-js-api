...
*Defined in [packages/api-derive/src/collective/proposals.ts:29](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/collective/proposals.ts#L29)*
