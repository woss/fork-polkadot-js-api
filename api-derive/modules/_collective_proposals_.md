...
*Defined in [packages/api-derive/src/collective/proposals.ts:29](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/collective/proposals.ts#L29)*
