...
*Defined in [packages/api-derive/src/collective/proposals.ts:29](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-derive/src/collective/proposals.ts#L29)*
