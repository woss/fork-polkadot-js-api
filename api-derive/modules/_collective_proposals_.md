...
*Defined in [packages/api-derive/src/collective/proposals.ts:29](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/collective/proposals.ts#L29)*
