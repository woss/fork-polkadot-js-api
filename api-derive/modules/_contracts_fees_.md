...
*Defined in [packages/api-derive/src/contracts/fees.ts:47](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/contracts/fees.ts#L47)*
