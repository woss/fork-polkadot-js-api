...
*Defined in [packages/api-derive/src/democracy/referendumInfos.ts:17](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api-derive/src/democracy/referendumInfos.ts#L17)*
