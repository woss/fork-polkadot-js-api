...
*Defined in [packages/api-derive/src/democracy/referendumInfos.ts:17](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/democracy/referendumInfos.ts#L17)*
