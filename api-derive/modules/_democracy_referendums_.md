...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-derive/src/democracy/referendums.ts#L15)*
