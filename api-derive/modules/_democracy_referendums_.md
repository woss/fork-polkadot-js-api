...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/democracy/referendums.ts#L15)*
