...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/586c90208/packages/api-derive/src/democracy/referendums.ts#L15)*
