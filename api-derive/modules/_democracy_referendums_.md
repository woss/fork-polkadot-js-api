...
*Defined in [packages/api-derive/src/democracy/referendums.ts:15](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/democracy/referendums.ts#L15)*
