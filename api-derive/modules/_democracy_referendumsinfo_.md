...
*Defined in [packages/api-derive/src/democracy/referendumsInfo.ts:16](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/democracy/referendumsInfo.ts#L16)*
