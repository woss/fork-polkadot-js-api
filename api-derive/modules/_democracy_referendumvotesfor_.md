...
*Defined in [packages/api-derive/src/democracy/referendumVotesFor.ts:16](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/democracy/referendumVotesFor.ts#L16)*
