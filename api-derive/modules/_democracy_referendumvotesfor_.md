...
*Defined in [packages/api-derive/src/democracy/referendumVotesFor.ts:16](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/democracy/referendumVotesFor.ts#L16)*
