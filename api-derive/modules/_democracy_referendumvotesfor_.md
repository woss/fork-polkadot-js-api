...
*Defined in [packages/api-derive/src/democracy/referendumVotesFor.ts:16](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/democracy/referendumVotesFor.ts#L16)*
