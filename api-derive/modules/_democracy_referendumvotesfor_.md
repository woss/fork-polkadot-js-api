...
*Defined in [packages/api-derive/src/democracy/referendumVotesFor.ts:16](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/democracy/referendumVotesFor.ts#L16)*
