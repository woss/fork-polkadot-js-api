...
*Defined in [packages/api-derive/src/democracy/referendumVotesFor.ts:16](https://github.com/polkadot-js/api/blob/586c90208/packages/api-derive/src/democracy/referendumVotesFor.ts#L16)*
