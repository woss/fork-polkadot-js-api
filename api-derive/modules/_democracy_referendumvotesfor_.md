...
*Defined in [packages/api-derive/src/democracy/referendumVotesFor.ts:16](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/democracy/referendumVotesFor.ts#L16)*
