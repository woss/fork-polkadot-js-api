...
*Defined in [packages/api-derive/src/democracy/votes.ts:13](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/democracy/votes.ts#L13)*
