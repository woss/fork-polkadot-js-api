...
*Defined in [packages/api-derive/src/democracy/votes.ts:13](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/democracy/votes.ts#L13)*
