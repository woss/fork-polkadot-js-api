...
*Defined in [packages/api-derive/src/democracy/votes.ts:13](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/democracy/votes.ts#L13)*
