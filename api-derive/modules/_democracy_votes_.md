...
*Defined in [packages/api-derive/src/democracy/votes.ts:13](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/democracy/votes.ts#L13)*
