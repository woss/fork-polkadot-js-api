...
*Defined in [packages/api-derive/src/democracy/votes.ts:13](https://github.com/polkadot-js/api/blob/196a0891b/packages/api-derive/src/democracy/votes.ts#L13)*
