...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/elections/info.ts#L57)*
