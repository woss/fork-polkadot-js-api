...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/elections/info.ts#L57)*
