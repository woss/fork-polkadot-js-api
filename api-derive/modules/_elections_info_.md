...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/elections/info.ts#L57)*
