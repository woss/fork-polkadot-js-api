...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/elections/info.ts#L57)*
