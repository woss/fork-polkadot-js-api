...
*Defined in [packages/api-derive/src/elections/info.ts:57](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api-derive/src/elections/info.ts#L57)*
