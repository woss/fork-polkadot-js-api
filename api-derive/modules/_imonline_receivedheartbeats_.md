...
*Defined in [packages/api-derive/src/imOnline/receivedHeartbeats.ts:18](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/imOnline/receivedHeartbeats.ts#L18)*
