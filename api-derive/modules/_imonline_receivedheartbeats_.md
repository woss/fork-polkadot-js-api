...
*Defined in [packages/api-derive/src/imOnline/receivedHeartbeats.ts:18](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/imOnline/receivedHeartbeats.ts#L18)*
