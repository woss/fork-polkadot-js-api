...
*Defined in [packages/api-derive/src/imOnline/receivedHeartbeats.ts:18](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/imOnline/receivedHeartbeats.ts#L18)*
