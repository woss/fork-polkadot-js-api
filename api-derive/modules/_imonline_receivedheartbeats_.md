...
*Defined in [packages/api-derive/src/imOnline/receivedHeartbeats.ts:18](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/imOnline/receivedHeartbeats.ts#L18)*
