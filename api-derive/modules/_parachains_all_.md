...
*Defined in [packages/api-derive/src/parachains/all.ts:94](https://github.com/polkadot-js/api/blob/790deca695/packages/api-derive/src/parachains/all.ts#L94)*
