...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/session/eraLength.ts#L13)*
