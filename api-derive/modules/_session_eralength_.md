...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/58de0b8b9c/packages/api-derive/src/session/eraLength.ts#L13)*
