...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/8ad3d35dd2/packages/api-derive/src/session/eraLength.ts#L13)*
