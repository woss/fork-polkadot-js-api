...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/f3c2c5c084/packages/api-derive/src/session/eraLength.ts#L13)*
