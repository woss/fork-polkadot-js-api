...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/63573ca0de/packages/api-derive/src/session/eraLength.ts#L13)*
