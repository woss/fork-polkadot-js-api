...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/3a1634d67f/packages/api-derive/src/session/eraLength.ts#L13)*
