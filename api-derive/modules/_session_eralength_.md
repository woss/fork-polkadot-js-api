...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/34be2399eb/packages/api-derive/src/session/eraLength.ts#L13)*
