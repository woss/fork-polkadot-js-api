...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/af643401b/packages/api-derive/src/session/eraLength.ts#L14)*
