...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/2d0ce2ddf/packages/api-derive/src/session/eraLength.ts#L14)*
