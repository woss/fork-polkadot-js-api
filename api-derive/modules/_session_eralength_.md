...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/908d0fcf52/packages/api-derive/src/session/eraLength.ts#L13)*
