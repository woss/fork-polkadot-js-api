...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/601288b3ec/packages/api-derive/src/session/eraLength.ts#L13)*
