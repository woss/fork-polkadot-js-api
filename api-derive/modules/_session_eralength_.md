...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/d818f61dc8/packages/api-derive/src/session/eraLength.ts#L13)*
