...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/aa37e372dd/packages/api-derive/src/session/eraLength.ts#L13)*
