...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/6aa0d90fc0/packages/api-derive/src/session/eraLength.ts#L13)*
