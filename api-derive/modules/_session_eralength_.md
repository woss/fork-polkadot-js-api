...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/b8cdfd226a/packages/api-derive/src/session/eraLength.ts#L13)*
