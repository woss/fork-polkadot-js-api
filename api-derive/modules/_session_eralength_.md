...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/02d130f0a0/packages/api-derive/src/session/eraLength.ts#L13)*
