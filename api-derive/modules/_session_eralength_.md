...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/session/eraLength.ts#L13)*
