...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/869f9b7af/packages/api-derive/src/session/eraLength.ts#L14)*
