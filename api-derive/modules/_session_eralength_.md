...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/9184268c3d/packages/api-derive/src/session/eraLength.ts#L13)*
