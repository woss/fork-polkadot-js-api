...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/bdfc582ba/packages/api-derive/src/session/eraLength.ts#L14)*
