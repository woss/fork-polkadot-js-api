...
*Defined in [packages/api-derive/src/session/eraLength.ts:14](https://github.com/polkadot-js/api/blob/ca76dc170/packages/api-derive/src/session/eraLength.ts#L14)*
