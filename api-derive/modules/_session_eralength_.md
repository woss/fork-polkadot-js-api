...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/cb9831c4f8/packages/api-derive/src/session/eraLength.ts#L13)*
