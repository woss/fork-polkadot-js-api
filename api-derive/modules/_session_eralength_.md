...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/69351ceb9e/packages/api-derive/src/session/eraLength.ts#L13)*
