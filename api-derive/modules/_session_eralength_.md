...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/3ee3fb05cc/packages/api-derive/src/session/eraLength.ts#L13)*
