...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/0fa6b99c9e/packages/api-derive/src/session/eraLength.ts#L13)*
