...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/session/eraLength.ts#L13)*
