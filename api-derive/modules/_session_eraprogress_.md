...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/f3c2c5c084/packages/api-derive/src/session/eraProgress.ts#L13)*
