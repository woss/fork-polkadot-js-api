...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/session/eraProgress.ts#L13)*
