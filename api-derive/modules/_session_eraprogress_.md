...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/99d4806a0d/packages/api-derive/src/session/eraProgress.ts#L13)*
