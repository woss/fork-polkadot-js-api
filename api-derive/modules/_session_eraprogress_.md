...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/e947c638f/packages/api-derive/src/session/eraProgress.ts#L13)*
