...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/dcf053633/packages/api-derive/src/session/eraProgress.ts#L14)*
