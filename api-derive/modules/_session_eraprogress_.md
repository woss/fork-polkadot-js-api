...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/bc2b0d513/packages/api-derive/src/session/eraProgress.ts#L13)*
