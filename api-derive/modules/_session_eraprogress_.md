...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/049a1a59f5/packages/api-derive/src/session/eraProgress.ts#L13)*
