...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/71b33e2e4/packages/api-derive/src/session/eraProgress.ts#L13)*
