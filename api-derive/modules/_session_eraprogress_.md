...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/6be6b027c/packages/api-derive/src/session/eraProgress.ts#L14)*
