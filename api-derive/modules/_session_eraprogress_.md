...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/session/eraProgress.ts#L13)*
