...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/8ad3d35dd2/packages/api-derive/src/session/eraProgress.ts#L13)*
