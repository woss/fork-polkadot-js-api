...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/602bb1406b/packages/api-derive/src/session/eraProgress.ts#L13)*
