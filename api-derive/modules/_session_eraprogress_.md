...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/db2ae1324/packages/api-derive/src/session/eraProgress.ts#L14)*
