...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/39c44bb5aa/packages/api-derive/src/session/eraProgress.ts#L13)*
