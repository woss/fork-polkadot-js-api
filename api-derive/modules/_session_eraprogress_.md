...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/b3a6b3dcb5/packages/api-derive/src/session/eraProgress.ts#L13)*
