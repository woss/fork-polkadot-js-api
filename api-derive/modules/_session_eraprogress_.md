...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/9ec1cb194a/packages/api-derive/src/session/eraProgress.ts#L13)*
