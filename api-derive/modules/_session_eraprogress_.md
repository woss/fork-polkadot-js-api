...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/6bb421dac/packages/api-derive/src/session/eraProgress.ts#L13)*
