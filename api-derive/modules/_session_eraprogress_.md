...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/7b8b4e8078/packages/api-derive/src/session/eraProgress.ts#L13)*
