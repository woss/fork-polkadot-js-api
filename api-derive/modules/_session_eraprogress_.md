...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/60c982ed95/packages/api-derive/src/session/eraProgress.ts#L13)*
