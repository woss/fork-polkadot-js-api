...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/77d894dd00/packages/api-derive/src/session/eraProgress.ts#L13)*
