...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/02d130f0a0/packages/api-derive/src/session/eraProgress.ts#L13)*
