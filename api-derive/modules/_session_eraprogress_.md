...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/aa37e372dd/packages/api-derive/src/session/eraProgress.ts#L13)*
