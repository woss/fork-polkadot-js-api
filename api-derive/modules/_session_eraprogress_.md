...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/0a6c6ec4c5/packages/api-derive/src/session/eraProgress.ts#L13)*
