...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/85ae6f949/packages/api-derive/src/session/eraProgress.ts#L14)*
