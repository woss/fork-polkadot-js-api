...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/a09fc51693/packages/api-derive/src/session/eraProgress.ts#L13)*
