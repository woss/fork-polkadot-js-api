...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/9bf854445c/packages/api-derive/src/session/eraProgress.ts#L13)*
