...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/a8f2ba8c3/packages/api-derive/src/session/eraProgress.ts#L14)*
