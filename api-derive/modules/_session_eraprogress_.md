...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/4e756704e/packages/api-derive/src/session/eraProgress.ts#L13)*
