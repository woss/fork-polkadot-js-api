...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/9184268c3d/packages/api-derive/src/session/eraProgress.ts#L13)*
