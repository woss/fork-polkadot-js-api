...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d818f61dc8/packages/api-derive/src/session/eraProgress.ts#L13)*
