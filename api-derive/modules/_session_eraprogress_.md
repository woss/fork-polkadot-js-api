...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/dd217f82b2/packages/api-derive/src/session/eraProgress.ts#L13)*
