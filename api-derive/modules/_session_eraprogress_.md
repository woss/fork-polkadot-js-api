...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d9ee39f36/packages/api-derive/src/session/eraProgress.ts#L13)*
