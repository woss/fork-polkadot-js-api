...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/110c9d199d/packages/api-derive/src/session/eraProgress.ts#L13)*
