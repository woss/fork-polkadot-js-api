...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/a35da085d/packages/api-derive/src/session/eraProgress.ts#L14)*
