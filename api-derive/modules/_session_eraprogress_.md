...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/34be2399eb/packages/api-derive/src/session/eraProgress.ts#L13)*
