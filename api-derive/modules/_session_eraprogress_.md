...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/6aa0d90fc0/packages/api-derive/src/session/eraProgress.ts#L13)*
