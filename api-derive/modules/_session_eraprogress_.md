...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/63573ca0de/packages/api-derive/src/session/eraProgress.ts#L13)*
