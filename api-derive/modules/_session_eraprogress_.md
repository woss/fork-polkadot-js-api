...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/9690777ac/packages/api-derive/src/session/eraProgress.ts#L14)*
