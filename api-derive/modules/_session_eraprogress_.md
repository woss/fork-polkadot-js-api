...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/114ac59707/packages/api-derive/src/session/eraProgress.ts#L13)*
