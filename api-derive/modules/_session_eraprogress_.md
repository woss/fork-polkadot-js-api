...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/f95384d9ff/packages/api-derive/src/session/eraProgress.ts#L13)*
