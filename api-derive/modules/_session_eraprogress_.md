...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/71c1d16dc4/packages/api-derive/src/session/eraProgress.ts#L13)*
