...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/eaf5216d4/packages/api-derive/src/session/eraProgress.ts#L13)*
