...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/51cb64ade/packages/api-derive/src/session/eraProgress.ts#L14)*
