...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/3a1634d67f/packages/api-derive/src/session/eraProgress.ts#L13)*
