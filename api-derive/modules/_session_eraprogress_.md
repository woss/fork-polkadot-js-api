...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/601288b3ec/packages/api-derive/src/session/eraProgress.ts#L13)*
