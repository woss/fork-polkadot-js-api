...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/0dc46445bc/packages/api-derive/src/session/eraProgress.ts#L13)*
