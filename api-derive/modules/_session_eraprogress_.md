...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/3ee3fb05cc/packages/api-derive/src/session/eraProgress.ts#L13)*
