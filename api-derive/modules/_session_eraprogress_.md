...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/8c6505d870/packages/api-derive/src/session/eraProgress.ts#L13)*
