...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/859800280/packages/api-derive/src/session/eraProgress.ts#L14)*
