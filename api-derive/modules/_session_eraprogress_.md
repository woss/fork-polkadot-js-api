...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/b8cdfd226a/packages/api-derive/src/session/eraProgress.ts#L13)*
