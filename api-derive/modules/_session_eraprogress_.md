...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/253e48f7b/packages/api-derive/src/session/eraProgress.ts#L14)*
