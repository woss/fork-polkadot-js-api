...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/0ad8be71f/packages/api-derive/src/session/eraProgress.ts#L14)*
