...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/27cd9b1ca4/packages/api-derive/src/session/eraProgress.ts#L13)*
