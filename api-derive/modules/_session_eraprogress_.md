...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/92cdc6c840/packages/api-derive/src/session/eraProgress.ts#L13)*
