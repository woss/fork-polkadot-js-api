...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/1a50298ff/packages/api-derive/src/session/eraProgress.ts#L14)*
