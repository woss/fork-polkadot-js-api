...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/2d0ce2ddf/packages/api-derive/src/session/eraProgress.ts#L14)*
