...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/session/eraProgress.ts#L14)*
