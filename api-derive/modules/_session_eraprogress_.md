...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api-derive/src/session/eraProgress.ts#L13)*
