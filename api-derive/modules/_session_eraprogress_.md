...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/d8d008108d/packages/api-derive/src/session/eraProgress.ts#L13)*
