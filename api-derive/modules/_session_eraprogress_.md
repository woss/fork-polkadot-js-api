...
*Defined in [packages/api-derive/src/session/eraProgress.ts:13](https://github.com/polkadot-js/api/blob/f59cb12ec/packages/api-derive/src/session/eraProgress.ts#L13)*
