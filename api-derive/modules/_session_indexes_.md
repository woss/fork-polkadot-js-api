...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/0a6c6ec4c5/packages/api-derive/src/session/indexes.ts#L78)*
