...
*Defined in [packages/api-derive/src/session/indexes.ts:75](https://github.com/polkadot-js/api/blob/0e297c677/packages/api-derive/src/session/indexes.ts#L75)*
