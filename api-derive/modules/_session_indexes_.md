...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/58de0b8b9c/packages/api-derive/src/session/indexes.ts#L78)*
