...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/a0979a9ce3/packages/api-derive/src/session/indexes.ts#L78)*
