...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/e6afed9bb1/packages/api-derive/src/session/indexes.ts#L78)*
