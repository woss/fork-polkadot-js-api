...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/session/indexes.ts#L78)*
