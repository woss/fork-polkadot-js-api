...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/049a1a59f5/packages/api-derive/src/session/indexes.ts#L78)*
