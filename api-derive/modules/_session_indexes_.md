...
*Defined in [packages/api-derive/src/session/indexes.ts:75](https://github.com/polkadot-js/api/blob/0ad8be71f/packages/api-derive/src/session/indexes.ts#L75)*
