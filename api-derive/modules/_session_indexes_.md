...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/6d95eb418d/packages/api-derive/src/session/indexes.ts#L78)*
