...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/f95384d9ff/packages/api-derive/src/session/indexes.ts#L78)*
