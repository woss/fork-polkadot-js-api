...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/d818f61dc8/packages/api-derive/src/session/indexes.ts#L78)*
