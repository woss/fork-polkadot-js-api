...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/69351ceb9e/packages/api-derive/src/session/indexes.ts#L78)*
