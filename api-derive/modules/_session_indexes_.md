...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/92cdc6c840/packages/api-derive/src/session/indexes.ts#L78)*
