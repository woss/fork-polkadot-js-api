...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/0dc46445bc/packages/api-derive/src/session/indexes.ts#L78)*
