...
*Defined in [packages/api-derive/src/session/indexes.ts:75](https://github.com/polkadot-js/api/blob/a4f56d3d3/packages/api-derive/src/session/indexes.ts#L75)*
