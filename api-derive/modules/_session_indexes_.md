...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/02d130f0a0/packages/api-derive/src/session/indexes.ts#L78)*
