...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/39c44bb5aa/packages/api-derive/src/session/indexes.ts#L78)*
