...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/9d67d711d4/packages/api-derive/src/session/indexes.ts#L78)*
