...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/session/indexes.ts#L78)*
