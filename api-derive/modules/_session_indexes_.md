...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/session/indexes.ts#L78)*
