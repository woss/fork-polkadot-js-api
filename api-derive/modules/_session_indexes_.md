...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/c472a451a4/packages/api-derive/src/session/indexes.ts#L78)*
