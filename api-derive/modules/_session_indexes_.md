...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/a241bd1c38/packages/api-derive/src/session/indexes.ts#L78)*
