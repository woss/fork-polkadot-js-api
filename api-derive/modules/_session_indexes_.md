...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/6a8e5370b6/packages/api-derive/src/session/indexes.ts#L78)*
