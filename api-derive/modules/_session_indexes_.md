...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/dd217f82b2/packages/api-derive/src/session/indexes.ts#L78)*
