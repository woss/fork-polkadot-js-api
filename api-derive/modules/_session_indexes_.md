...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/1750522cb6/packages/api-derive/src/session/indexes.ts#L78)*
