...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/3a1634d67f/packages/api-derive/src/session/indexes.ts#L78)*
