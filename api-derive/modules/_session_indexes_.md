...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api-derive/src/session/indexes.ts#L78)*
