...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/908d0fcf52/packages/api-derive/src/session/indexes.ts#L78)*
