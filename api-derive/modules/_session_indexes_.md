...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/71c1d16dc4/packages/api-derive/src/session/indexes.ts#L78)*
