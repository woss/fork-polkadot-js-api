...
*Defined in [packages/api-derive/src/session/indexes.ts:75](https://github.com/polkadot-js/api/blob/e8cd8c944/packages/api-derive/src/session/indexes.ts#L75)*
