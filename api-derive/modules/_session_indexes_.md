...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/0fa6b99c9e/packages/api-derive/src/session/indexes.ts#L78)*
