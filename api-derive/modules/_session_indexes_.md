...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/602bb1406b/packages/api-derive/src/session/indexes.ts#L78)*
