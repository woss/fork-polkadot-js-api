...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/2e83d92adc/packages/api-derive/src/session/indexes.ts#L78)*
