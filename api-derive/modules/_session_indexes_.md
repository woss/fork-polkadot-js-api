...
*Defined in [packages/api-derive/src/session/indexes.ts:75](https://github.com/polkadot-js/api/blob/94608b0c3/packages/api-derive/src/session/indexes.ts#L75)*
