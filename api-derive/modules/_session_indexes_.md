...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/e7a01f9780/packages/api-derive/src/session/indexes.ts#L78)*
