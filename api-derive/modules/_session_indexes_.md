...
*Defined in [packages/api-derive/src/session/indexes.ts:78](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/session/indexes.ts#L78)*
