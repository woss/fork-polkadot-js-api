...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/d531dd374/packages/api-derive/src/session/sessionProgress.ts#L14)*
