...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/2b6aa7972/packages/api-derive/src/session/sessionProgress.ts#L13)*
