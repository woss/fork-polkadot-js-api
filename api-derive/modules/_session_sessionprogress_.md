...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/8c011cdc86/packages/api-derive/src/session/sessionProgress.ts#L13)*
