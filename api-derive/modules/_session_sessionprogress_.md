...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/f71211f5dc/packages/api-derive/src/session/sessionProgress.ts#L13)*
