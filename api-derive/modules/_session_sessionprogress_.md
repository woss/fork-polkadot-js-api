...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/85ae6f949/packages/api-derive/src/session/sessionProgress.ts#L14)*
