...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/2d40d370f/packages/api-derive/src/session/sessionProgress.ts#L14)*
