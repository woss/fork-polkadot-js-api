...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/dd217f82b2/packages/api-derive/src/session/sessionProgress.ts#L13)*
