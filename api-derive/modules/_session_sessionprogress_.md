...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/a8f2ba8c3/packages/api-derive/src/session/sessionProgress.ts#L14)*
