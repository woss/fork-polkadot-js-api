...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/21a2b5f0b7/packages/api-derive/src/session/sessionProgress.ts#L13)*
