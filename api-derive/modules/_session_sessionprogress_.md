...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/94608b0c3/packages/api-derive/src/session/sessionProgress.ts#L13)*
