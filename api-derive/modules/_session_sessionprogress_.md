...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/619ef6f8e/packages/api-derive/src/session/sessionProgress.ts#L14)*
