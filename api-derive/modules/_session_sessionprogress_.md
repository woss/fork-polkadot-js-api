...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/session/sessionProgress.ts#L13)*
