...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/c3c77ffe4/packages/api-derive/src/session/sessionProgress.ts#L14)*
