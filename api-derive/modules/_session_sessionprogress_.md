...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/39f22ca403/packages/api-derive/src/session/sessionProgress.ts#L13)*
