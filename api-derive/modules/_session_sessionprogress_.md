...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/a4ea4d648a/packages/api-derive/src/session/sessionProgress.ts#L13)*
