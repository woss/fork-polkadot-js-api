...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/196a0891b/packages/api-derive/src/session/sessionProgress.ts#L14)*
