...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/session/sessionProgress.ts#L14)*
