...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/f5c140d1c2/packages/api-derive/src/session/sessionProgress.ts#L13)*
