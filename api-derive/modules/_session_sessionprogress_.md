...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/9690777ac/packages/api-derive/src/session/sessionProgress.ts#L14)*
