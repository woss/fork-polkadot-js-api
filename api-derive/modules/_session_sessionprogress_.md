...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api-derive/src/session/sessionProgress.ts#L13)*
