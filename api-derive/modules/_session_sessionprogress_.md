...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/39c44bb5aa/packages/api-derive/src/session/sessionProgress.ts#L13)*
