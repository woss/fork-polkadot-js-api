...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/f95384d9ff/packages/api-derive/src/session/sessionProgress.ts#L13)*
