...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/57e2a9dc1/packages/api-derive/src/session/sessionProgress.ts#L13)*
