...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/bdfc582ba/packages/api-derive/src/session/sessionProgress.ts#L14)*
