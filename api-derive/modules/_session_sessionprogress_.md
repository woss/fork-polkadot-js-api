...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/affa5d390c/packages/api-derive/src/session/sessionProgress.ts#L13)*
