...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/a7132b4e9/packages/api-derive/src/session/sessionProgress.ts#L14)*
