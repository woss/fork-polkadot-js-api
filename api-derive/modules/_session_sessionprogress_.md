...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/869f9b7af/packages/api-derive/src/session/sessionProgress.ts#L14)*
