...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/114ac59707/packages/api-derive/src/session/sessionProgress.ts#L13)*
