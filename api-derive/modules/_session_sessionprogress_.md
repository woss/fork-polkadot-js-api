...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/4e2fb23bd/packages/api-derive/src/session/sessionProgress.ts#L13)*
