...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/bab79b647/packages/api-derive/src/session/sessionProgress.ts#L14)*
