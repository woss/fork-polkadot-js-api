...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/a613308bdb/packages/api-derive/src/session/sessionProgress.ts#L13)*
