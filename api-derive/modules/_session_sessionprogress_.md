...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/a4f56d3d3/packages/api-derive/src/session/sessionProgress.ts#L14)*
