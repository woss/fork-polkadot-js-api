...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/adee447cd/packages/api-derive/src/session/sessionProgress.ts#L13)*
