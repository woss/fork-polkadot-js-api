...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/af643401b/packages/api-derive/src/session/sessionProgress.ts#L14)*
