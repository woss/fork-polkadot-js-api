...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/e8cd8c944/packages/api-derive/src/session/sessionProgress.ts#L13)*
