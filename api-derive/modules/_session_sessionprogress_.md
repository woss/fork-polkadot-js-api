...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/3a37bf1e6b/packages/api-derive/src/session/sessionProgress.ts#L13)*
