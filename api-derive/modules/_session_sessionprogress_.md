...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:13](https://github.com/polkadot-js/api/blob/6a8e5370b6/packages/api-derive/src/session/sessionProgress.ts#L13)*
