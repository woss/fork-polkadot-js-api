...
*Defined in [packages/api-derive/src/session/sessionProgress.ts:14](https://github.com/polkadot-js/api/blob/6c5ef6ecd/packages/api-derive/src/session/sessionProgress.ts#L14)*
