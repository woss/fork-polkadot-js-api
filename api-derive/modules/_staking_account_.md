...
*Defined in [packages/api-derive/src/staking/account.ts:90](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/staking/account.ts#L90)*
