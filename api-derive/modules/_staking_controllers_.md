...
*Defined in [packages/api-derive/src/staking/controllers.ts:20](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/staking/controllers.ts#L20)*
