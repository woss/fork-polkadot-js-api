...
*Defined in [packages/api-derive/src/staking/controllers.ts:20](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/staking/controllers.ts#L20)*
