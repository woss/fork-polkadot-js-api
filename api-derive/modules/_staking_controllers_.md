...
*Defined in [packages/api-derive/src/staking/controllers.ts:20](https://github.com/polkadot-js/api/blob/553b3df0b/packages/api-derive/src/staking/controllers.ts#L20)*
