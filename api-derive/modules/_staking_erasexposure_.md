...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:38](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/staking/erasExposure.ts#L38)*
...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:48](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/staking/erasExposure.ts#L48)*
