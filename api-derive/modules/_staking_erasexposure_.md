...
*Defined in [packages/api-derive/src/staking/erasExposure.ts:36](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/staking/erasExposure.ts#L36)*
