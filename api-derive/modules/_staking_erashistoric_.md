...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:16](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api-derive/src/staking/erasHistoric.ts#L16)*
