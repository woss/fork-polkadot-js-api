...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:16](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api-derive/src/staking/erasHistoric.ts#L16)*
