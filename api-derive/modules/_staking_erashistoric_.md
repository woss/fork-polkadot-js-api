...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:16](https://github.com/polkadot-js/api/blob/044efbc6de/packages/api-derive/src/staking/erasHistoric.ts#L16)*
