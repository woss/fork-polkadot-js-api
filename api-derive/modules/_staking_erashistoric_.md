...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:16](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/staking/erasHistoric.ts#L16)*
