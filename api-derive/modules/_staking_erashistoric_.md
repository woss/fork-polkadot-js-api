...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:16](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api-derive/src/staking/erasHistoric.ts#L16)*
