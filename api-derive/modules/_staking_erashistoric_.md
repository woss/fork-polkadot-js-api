...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:16](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/staking/erasHistoric.ts#L16)*
