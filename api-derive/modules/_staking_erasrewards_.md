...
*Defined in [packages/api-derive/src/staking/erasRewards.ts:16](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/staking/erasRewards.ts#L16)*
