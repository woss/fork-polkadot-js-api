...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:32](https://github.com/polkadot-js/api/blob/044efbc6de/packages/api-derive/src/staking/erasSlashes.ts#L32)*
...
*Defined in [packages/api-derive/src/staking/erasSlashes.ts:43](https://github.com/polkadot-js/api/blob/044efbc6de/packages/api-derive/src/staking/erasSlashes.ts#L43)*
