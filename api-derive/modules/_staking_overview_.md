...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/619ef6f8e/packages/api-derive/src/staking/overview.ts#L33)*
