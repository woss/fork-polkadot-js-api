...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/4e2fb23bd/packages/api-derive/src/staking/overview.ts#L33)*
