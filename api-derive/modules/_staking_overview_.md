...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/9ec1cb194a/packages/api-derive/src/staking/overview.ts#L32)*
