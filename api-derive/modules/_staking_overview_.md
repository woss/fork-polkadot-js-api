...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/6f85c6783e/packages/api-derive/src/staking/overview.ts#L33)*
