...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/114ac59707/packages/api-derive/src/staking/overview.ts#L32)*
