...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/staking/overview.ts#L33)*
