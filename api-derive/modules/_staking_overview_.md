...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/9690777ac/packages/api-derive/src/staking/overview.ts#L33)*
