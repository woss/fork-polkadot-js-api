...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/staking/overview.ts#L17)*
