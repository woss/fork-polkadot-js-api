...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api-derive/src/staking/overview.ts#L32)*
