...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/f95384d9ff/packages/api-derive/src/staking/overview.ts#L32)*
