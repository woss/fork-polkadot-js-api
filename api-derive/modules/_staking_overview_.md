...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/553b3df0b/packages/api-derive/src/staking/overview.ts#L17)*
