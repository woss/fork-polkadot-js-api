...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/b58823883/packages/api-derive/src/staking/overview.ts#L33)*
