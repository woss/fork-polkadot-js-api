...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/60c982ed95/packages/api-derive/src/staking/overview.ts#L33)*
