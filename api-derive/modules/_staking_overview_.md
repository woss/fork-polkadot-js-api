...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/0fa6b99c9e/packages/api-derive/src/staking/overview.ts#L33)*
