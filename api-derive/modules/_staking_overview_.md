...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/63573ca0de/packages/api-derive/src/staking/overview.ts#L32)*
