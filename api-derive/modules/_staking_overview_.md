...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/d8d008108d/packages/api-derive/src/staking/overview.ts#L32)*
