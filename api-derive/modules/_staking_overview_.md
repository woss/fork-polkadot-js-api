...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/85ae6f949/packages/api-derive/src/staking/overview.ts#L33)*
