...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api-derive/src/staking/overview.ts#L32)*
