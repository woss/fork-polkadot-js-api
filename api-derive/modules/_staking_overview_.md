...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/922cfb8759/packages/api-derive/src/staking/overview.ts#L32)*
