...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/a4ea4d648a/packages/api-derive/src/staking/overview.ts#L32)*
