...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/253e48f7b/packages/api-derive/src/staking/overview.ts#L33)*
