...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/staking/overview.ts#L32)*
