...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/f942510309/packages/api-derive/src/staking/overview.ts#L32)*
