...
*Defined in [packages/api-derive/src/staking/overview.ts:33](https://github.com/polkadot-js/api/blob/8c6505d870/packages/api-derive/src/staking/overview.ts#L33)*
