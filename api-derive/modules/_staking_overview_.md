...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/602bb1406b/packages/api-derive/src/staking/overview.ts#L32)*
