...
*Defined in [packages/api-derive/src/staking/overview.ts:17](https://github.com/polkadot-js/api/blob/790deca695/packages/api-derive/src/staking/overview.ts#L17)*
