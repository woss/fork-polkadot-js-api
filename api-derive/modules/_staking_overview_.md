...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/3f4576f524/packages/api-derive/src/staking/overview.ts#L32)*
