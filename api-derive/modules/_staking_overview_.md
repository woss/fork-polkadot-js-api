...
*Defined in [packages/api-derive/src/staking/overview.ts:32](https://github.com/polkadot-js/api/blob/27cd9b1ca4/packages/api-derive/src/staking/overview.ts#L32)*
