...
*Defined in [packages/api-derive/src/staking/ownSlashes.ts:14](https://github.com/polkadot-js/api/blob/044efbc6de/packages/api-derive/src/staking/ownSlashes.ts#L14)*
