...
*Defined in [packages/api-derive/src/staking/query.ts:81](https://github.com/polkadot-js/api/blob/908d0fcf52/packages/api-derive/src/staking/query.ts#L81)*
...
*Defined in [packages/api-derive/src/staking/query.ts:98](https://github.com/polkadot-js/api/blob/908d0fcf52/packages/api-derive/src/staking/query.ts#L98)*
