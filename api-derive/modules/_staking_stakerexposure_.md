...
*Defined in [packages/api-derive/src/staking/stakerExposure.ts:14](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api-derive/src/staking/stakerExposure.ts#L14)*
