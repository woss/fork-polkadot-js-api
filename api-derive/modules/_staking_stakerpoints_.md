...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:14](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api-derive/src/staking/stakerPoints.ts#L14)*
