...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:14](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api-derive/src/staking/stakerPoints.ts#L14)*
