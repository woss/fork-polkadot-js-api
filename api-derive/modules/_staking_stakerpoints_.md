...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:14](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api-derive/src/staking/stakerPoints.ts#L14)*
