...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:14](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api-derive/src/staking/stakerPoints.ts#L14)*
