...
*Defined in [packages/api-derive/src/staking/stakerRewards.ts:67](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/staking/stakerRewards.ts#L67)*
...
*Defined in [packages/api-derive/src/staking/stakerRewards.ts:84](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/staking/stakerRewards.ts#L84)*
