...
*Defined in [packages/api-derive/src/staking/stakerRewards.ts:13](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/staking/stakerRewards.ts#L13)*
