...
*Defined in [packages/api-derive/src/staking/stakerSlashes.ts:14](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api-derive/src/staking/stakerSlashes.ts#L14)*
