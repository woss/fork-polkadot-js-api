...
*Defined in [packages/api-derive/src/staking/validators.ts:16](https://github.com/polkadot-js/api/blob/86ce69680/packages/api-derive/src/staking/validators.ts#L16)*
