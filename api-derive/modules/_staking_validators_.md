...
*Defined in [packages/api-derive/src/staking/validators.ts:31](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api-derive/src/staking/validators.ts#L31)*
