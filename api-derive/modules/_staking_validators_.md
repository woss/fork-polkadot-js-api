...
*Defined in [packages/api-derive/src/staking/validators.ts:17](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api-derive/src/staking/validators.ts#L17)*
