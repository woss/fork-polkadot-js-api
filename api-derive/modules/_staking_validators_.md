...
*Defined in [packages/api-derive/src/staking/validators.ts:16](https://github.com/polkadot-js/api/blob/859800280/packages/api-derive/src/staking/validators.ts#L16)*
