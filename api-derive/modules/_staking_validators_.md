...
*Defined in [packages/api-derive/src/staking/validators.ts:16](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api-derive/src/staking/validators.ts#L16)*
