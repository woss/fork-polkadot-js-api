...
*Defined in [packages/api-derive/src/staking/validators.ts:16](https://github.com/polkadot-js/api/blob/586c90208/packages/api-derive/src/staking/validators.ts#L16)*
