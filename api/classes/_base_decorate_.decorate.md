...
*Defined in [api/src/base/Decorate.ts:108](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/base/Decorate.ts#L108)*
...
*Defined in [api/src/base/Decorate.ts:163](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/base/Decorate.ts#L163)*
