...
*Defined in [api/src/promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/9ea6053a42/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [api/src/promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/9ea6053a42/packages/api/src/promise/Combinator.ts#L76)*
