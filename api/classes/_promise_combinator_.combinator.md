...
*Defined in [api/src/promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [api/src/promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api/src/promise/Combinator.ts#L76)*
