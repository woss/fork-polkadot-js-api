...
*Defined in [api/src/promise/Combinator.ts:28](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/promise/Combinator.ts#L28)*
...
*Defined in [api/src/promise/Combinator.ts:76](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/promise/Combinator.ts#L76)*
