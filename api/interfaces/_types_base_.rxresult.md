...
*Defined in [api/src/types/base.ts:48](https://github.com/polkadot-js/api/blob/2d0ce2ddf/packages/api/src/types/base.ts#L48)*
...
*Defined in [api/src/types/base.ts:49](https://github.com/polkadot-js/api/blob/2d0ce2ddf/packages/api/src/types/base.ts#L49)*
