...
*Defined in [api/src/types/storage.ts:73](https://github.com/polkadot-js/api/blob/586c90208/packages/api/src/types/storage.ts#L73)*
...
*Defined in [api/src/types/storage.ts:74](https://github.com/polkadot-js/api/blob/586c90208/packages/api/src/types/storage.ts#L74)*
