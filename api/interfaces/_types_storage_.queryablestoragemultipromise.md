...
*Defined in [api/src/types/storage.ts:72](https://github.com/polkadot-js/api/blob/7316f68cd/packages/api/src/types/storage.ts#L72)*
...
*Defined in [api/src/types/storage.ts:73](https://github.com/polkadot-js/api/blob/7316f68cd/packages/api/src/types/storage.ts#L73)*
