...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/908d0fcf52/packages/api/src/submittable/createSubmittable.ts#L17)*
