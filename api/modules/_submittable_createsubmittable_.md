...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/submittable/createSubmittable.ts#L17)*
