...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9690777ac/packages/api/src/submittable/createSubmittable.ts#L17)*
