...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/d9dad3566a/packages/api/src/submittable/createSubmittable.ts#L17)*
