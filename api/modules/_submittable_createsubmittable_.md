...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/85ae6f949/packages/api/src/submittable/createSubmittable.ts#L17)*
