...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/63573ca0de/packages/api/src/submittable/createSubmittable.ts#L17)*
