...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/69020faaa/packages/api/src/submittable/createSubmittable.ts#L17)*
