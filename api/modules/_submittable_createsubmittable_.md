...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/aaf127379/packages/api/src/submittable/createSubmittable.ts#L17)*
