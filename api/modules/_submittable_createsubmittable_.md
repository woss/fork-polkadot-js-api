...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/64f64c1001/packages/api/src/submittable/createSubmittable.ts#L17)*
