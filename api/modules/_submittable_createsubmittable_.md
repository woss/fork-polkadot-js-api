...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/f95384d9ff/packages/api/src/submittable/createSubmittable.ts#L17)*
