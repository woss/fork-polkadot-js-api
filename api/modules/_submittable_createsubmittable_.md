...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/196a0891b/packages/api/src/submittable/createSubmittable.ts#L17)*
