...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/044efbc6de/packages/api/src/submittable/createSubmittable.ts#L17)*
