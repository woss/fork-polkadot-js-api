...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9ec1cb194a/packages/api/src/submittable/createSubmittable.ts#L17)*
