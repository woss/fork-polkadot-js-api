...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/4e2fb23bd/packages/api/src/submittable/createSubmittable.ts#L17)*
