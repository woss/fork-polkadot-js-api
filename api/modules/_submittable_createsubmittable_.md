...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/110c9d199d/packages/api/src/submittable/createSubmittable.ts#L17)*
