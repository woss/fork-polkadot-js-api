...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/api/src/submittable/createSubmittable.ts#L17)*
