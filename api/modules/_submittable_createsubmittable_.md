...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/adee447cd/packages/api/src/submittable/createSubmittable.ts#L17)*
