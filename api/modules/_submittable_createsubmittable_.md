...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/0fa6b99c9e/packages/api/src/submittable/createSubmittable.ts#L17)*
