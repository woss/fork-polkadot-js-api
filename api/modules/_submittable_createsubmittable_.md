...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/2b4bd75499/packages/api/src/submittable/createSubmittable.ts#L17)*
