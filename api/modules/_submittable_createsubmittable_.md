...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/1a50298ff/packages/api/src/submittable/createSubmittable.ts#L17)*
