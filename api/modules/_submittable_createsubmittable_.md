...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/d8d008108d/packages/api/src/submittable/createSubmittable.ts#L17)*
