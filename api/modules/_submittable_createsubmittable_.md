...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/60c982ed95/packages/api/src/submittable/createSubmittable.ts#L17)*
