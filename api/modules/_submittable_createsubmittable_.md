...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/8c6505d870/packages/api/src/submittable/createSubmittable.ts#L17)*
