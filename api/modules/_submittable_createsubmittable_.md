...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/submittable/createSubmittable.ts#L17)*
