...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/619ef6f8e/packages/api/src/submittable/createSubmittable.ts#L17)*
