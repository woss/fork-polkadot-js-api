...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/790deca695/packages/api/src/submittable/createSubmittable.ts#L17)*
