...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/30d4d8c3a/packages/api/src/submittable/createSubmittable.ts#L17)*
