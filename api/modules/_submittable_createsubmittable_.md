...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/852e0d4f0b/packages/api/src/submittable/createSubmittable.ts#L17)*
