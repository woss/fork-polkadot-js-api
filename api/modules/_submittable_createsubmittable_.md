...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/0e264a029/packages/api/src/submittable/createSubmittable.ts#L17)*
