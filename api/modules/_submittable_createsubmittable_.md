...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/81a2a51610/packages/api/src/submittable/createSubmittable.ts#L17)*
