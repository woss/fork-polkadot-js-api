...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/553b3df0b/packages/api/src/submittable/createSubmittable.ts#L17)*
