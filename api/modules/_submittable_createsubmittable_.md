...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/94a3b1f09a/packages/api/src/submittable/createSubmittable.ts#L17)*
