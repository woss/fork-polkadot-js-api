...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/b8cdfd226a/packages/api/src/submittable/createSubmittable.ts#L17)*
