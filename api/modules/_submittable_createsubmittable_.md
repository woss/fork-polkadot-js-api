...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/922cfb8759/packages/api/src/submittable/createSubmittable.ts#L17)*
