...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/253e48f7b/packages/api/src/submittable/createSubmittable.ts#L17)*
