...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/70a26e33a/packages/api/src/submittable/createSubmittable.ts#L17)*
