...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/82addc4f6a/packages/api/src/submittable/createSubmittable.ts#L17)*
