...
*Defined in [api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/f73609103/packages/api/src/submittable/createSubmittable.ts#L17)*
