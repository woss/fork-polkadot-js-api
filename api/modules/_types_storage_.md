...
*Defined in [api/src/types/storage.ts:16](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/types/storage.ts#L16)*
...
*Defined in [api/src/types/storage.ts:18](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/types/storage.ts#L18)*
...
*Defined in [api/src/types/storage.ts:23](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/types/storage.ts#L23)*
...
*Defined in [api/src/types/storage.ts:79](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/types/storage.ts#L79)*
...
*Defined in [api/src/types/storage.ts:66](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/types/storage.ts#L66)*
