...
*Defined in [api/src/util/decorate.ts:13](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/util/decorate.ts#L13)*
...
*Defined in [api/src/util/decorate.ts:46](https://github.com/polkadot-js/api/blob/82c1e3f35a/packages/api/src/util/decorate.ts#L46)*
