...
*Defined in [api/src/util/decorate.ts:13](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/util/decorate.ts#L13)*
...
*Defined in [api/src/util/decorate.ts:46](https://github.com/polkadot-js/api/blob/7a7d6e9b8a/packages/api/src/util/decorate.ts#L46)*
