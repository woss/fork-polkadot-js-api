...
declare module '@polkadot/api/types/submittable' {
    interface AugmentedSubmittables<ApiType> {
        ...
        democracy: {
             ...
             * # </weight>
             **/
            vote: AugmentedSubmittable<(refIndex: Compact<ReferendumIndex> | AnyNumber | Uint8Array, vote: Vote | {
                aye: boolean;
             ...
             * # </weight>
             **/
            proxyVote: AugmentedSubmittable<(refIndex: Compact<ReferendumIndex> | AnyNumber | Uint8Array, vote: Vote | {
                aye: boolean;
                conviction?: ('None' | 'Locked1x' | 'Locked2x' | 'Locked3x' | 'Locked4x' | 'Locked5x' | 'Locked6x') | number;
            } | boolean | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
            /**
        ...
        sudo: {
             ...
             * # </weight>
             **/
            sudo: AugmentedSubmittable<(proposal: Proposal | {
                callIndex?: any;
                args?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
            /**
             ...
             * # </weight>
             **/
            sudoAs: AugmentedSubmittable<(who: LookupSource | Address | AccountId | AccountIndex | string | Uint8Array, proposal: Proposal | {
                callIndex?: any;
                args?: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
        };
