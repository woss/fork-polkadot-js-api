...
| [EventRecord](interfaces/_interfaceregistry_.interfaceregistry.md#eventrecord) | A record for an [Event](classes/_generic_event_.event.md) (as specified by [[Metadata]]) with the specific [Phase](interfaces/_interfaceregistry_.interfaceregistry.md#phase) of application |
...
| [StorageData](interfaces/_interfaceregistry_.interfaceregistry.md#storagedata) | Data retrieved via Storage queries and data for key-value pairs |
