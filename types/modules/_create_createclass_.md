...
*Defined in [packages/types/src/create/createClass.ts:41](https://github.com/polkadot-js/api/blob/81a2a51610/packages/types/src/create/createClass.ts#L41)*
...
*Defined in [packages/types/src/create/createClass.ts:36](https://github.com/polkadot-js/api/blob/81a2a51610/packages/types/src/create/createClass.ts#L36)*
...
*Defined in [packages/types/src/create/createClass.ts:28](https://github.com/polkadot-js/api/blob/81a2a51610/packages/types/src/create/createClass.ts#L28)*
...
*Defined in [packages/types/src/create/createClass.ts:174](https://github.com/polkadot-js/api/blob/81a2a51610/packages/types/src/create/createClass.ts#L174)*
