...
*Defined in [packages/types/src/create/createType.ts:76](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/types/src/create/createType.ts#L76)*
...
*Defined in [packages/types/src/create/createType.ts:60](https://github.com/polkadot-js/api/blob/295cd2a7e0/packages/types/src/create/createType.ts#L60)*
